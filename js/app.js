  ...
  return `
    <div class="detail-contact">
      <div class="detail-contact-copy">
        ...
        <p>İlan sahibiyle doğrudan WhatsApp üzerinden konuş.</p>
      </div>
      <a class="btn-whatsapp" href="${buildWhatsAppLink(whatsapp, item)}" target="_blank" rel="noopener noreferrer">
        ...
        <span class="btn-whatsapp-text">
          ...
          <span class="btn-whatsapp-sub">Mesaj şablonu hazır</span>
        </span>
        <span class="btn-whatsapp-arrow" aria-hidden="true">→</span>
      </a>
    </div>`;
}
